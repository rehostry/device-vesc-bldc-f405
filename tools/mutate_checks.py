...
MUTATIONS = [
    ...
    ("float16 goes back to rounding instead of the firmware's truncation",
     ATTACK.parent / "vesc_comm.py", "    return struct.pack(\">h\", int(prod))",
     "    return struct.pack(\">h\", int(round(prod)))"),
